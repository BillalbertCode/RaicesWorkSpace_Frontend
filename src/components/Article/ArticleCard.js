                ...
                <div className={`card-header ${styles.bgMetallicFormArticle}`}>
                    <div className=" d-flex p-1 " >
                        ...
                        <Link className=" mx-3 text-start link-dark link-offset-2 link-underline link-underline-opacity-0" href={`/profile/${article.author._id}`}>
                            ...
                            <p className="text-secondary" >@{article.author.username}</p>
                        </Link>
                    </div>
                </div>
                <div className="col-md-4 d-flex">
                    <img className="object-fit-cover rounded-start img-fluid " src="https://th.bing.com/th/id/OIG1.qgdQ.k4SM9tOiXSWI2Jw?w=1024&h=1024&rs=1&pid=ImgDetMain"  title={article.title || article.content} />
                </div>
                <div className="col-md-8 ">
                    <div className="card-body container h-100 position-relative d-flex flex-column justify-content-between ">
                        <div className="position-absolute top-1 ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-blockquote-left" viewBox="0 0 16 16">
                        ...
                        <p className="card-text mt-2 ">{article.content || <small className="text-secondary">Sin descripcion..</small>}</p>
                        ...
                        <Link className=" link-dark link-offset-2 link-underline link-underline-opacity-0" href={`/profile/${article.author._id}`}>
                            ...
                            <small className="text-body-secondary mx-1">
