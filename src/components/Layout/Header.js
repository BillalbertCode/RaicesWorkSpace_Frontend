...
const Header = () => {
  ...
  return (
    <Navbar data-bs-theme="dark" ref={navbarRef} expand="lg" className="bg-black position-relative overflow-hidden">
      ...
      <Container fluid >
        ...
        <Navbar.Brand className="z-1" >
          <Link className="link-white link-underline link-underline-opacity-0" href="/">Raices</Link>
        </Navbar.Brand>
        ...
        <Navbar.Collapse  id="basic-navbar-nav">
          <Nav className="container-fluid d-flex justify-content-end " >
            <div className={`z-1 d-flex align-items-center ${stylesNavbar.navContainer}`}>
              ...
              <Link className="link-white link-underline link-underline-opacity-0" href="/">Home</Link>
            </div>
            ...
            {loginStatus
              ? (<>
                <div className={`z-1 d-flex align-items-center ${stylesNavbar.navContainer}`}>
                  ...
                  <Link className="link-white link-underline link-underline-opacity-0" href="/profile"> Profile</Link>
                </div>
                <div className={`z-1 d-flex align-items-center ${stylesNavbar.navContainer}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={stylesNavbar.navIcons} viewBox="0 0 16 16">
                  ...
                  <button className="btn btn-white btn-sm" onClick={() => closedSession()}>Cerrar Sesion</button>
                </div>
              </>)
              :
              <div className={`z-1 d-flex align-items-center ${stylesNavbar.navContainer}`}>
