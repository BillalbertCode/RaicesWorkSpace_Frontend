    ...
    <Navbar ref={navbarRef} expand="lg" className="bg-transparent position-relative overflow-hidden">
      ...
      <Container fluid >
        ...
        <Navbar.Collapse className="d-flex justify-content-end " id="basic-navbar-nav ">
          <Nav className="z-1 gap-3" >
            <div className={`d-flex align-items-center ${stylesNavbar.navContainer}`}>
              <span >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class={stylesNavbar.navIcons} viewBox="0 0 16 16">
